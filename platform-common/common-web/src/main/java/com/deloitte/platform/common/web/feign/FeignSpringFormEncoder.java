...
public class FeignSpringFormEncoder implements Encoder {
    ...
    public FeignSpringFormEncoder() {
        ...
        for(HttpMessageConverter<?> messageConvert : converters){
            if(messageConvert instanceof AllEncompassingFormHttpMessageConverter){
                ...
                converters.set(i, new GdcAllEncompassingFormHttpMessageConverter());
            }
            i++;
        }
    ...
    public void encode(Object object, Type bodyType, RequestTemplate template) throws EncodeException {
    	...
    	else if (isFormRequest(bodyType)) {
    ...
    private void
    encodeRequest(Object value, HttpHeaders requestHeaders, RequestTemplate template) throws EncodeException {
    ...
    static boolean isFormRequest(Type type) {
        return Encoder.MAP_STRING_WILDCARD.equals(type);
    }
