...
/**
 * @Author : jackliu
 * @Date : Create in 16:22 13/03/2019
 * @Description :
 * @Modified :
 */
public class GdcFormHttpMessageConverter implements HttpMessageConverter<MultiValueMap<String, ?>> {
    ...
    public GdcFormHttpMessageConverter() {
    ...
    private void writePart(String name, HttpEntity<?> partEntity, OutputStream os) throws IOException {
        ...
        for (HttpMessageConverter<?> messageConverter : this.partConverters) {
            if (messageConverter.canWrite(partType, partContentType)) {
                HttpOutputMessage multipartMessage = new GdcFormHttpMessageConverter.MultipartHttpOutputMessage(os);
    ...
    protected String getFilename(Object part) {
        if (part instanceof Resource) {
            ...
            if (filename != null && this.multipartCharset != null) {
                filename = GdcFormHttpMessageConverter.MimeDelegate.encode(filename, this.multipartCharset.name());
            }
            return filename;
        }
        else {
