...
@TableName("TAS_TRAVLE_APPLY_INFO")
@ApiModel(value="TasTravleApplyInfo对象", description="")
public class TasTravelApplyInfo extends Model<TasTravelApplyInfo> {
    ...
    @TableField("IS_BORROW_CONNECT")
    @ApiModelProperty("是否被借款单关联")
    private String isBorrowConnect;

    @TableField("IS_REIMBUR_CONNECT")
    ...
    public static final String WHETHER_LEAVE_BJ = "WHETHER_LEAVE_BJ";

    public static final String WHETHER_BORROW = "WHETHER_BORROW";

    public static final String WHETHER_RECEPTION = "WHETHER_RECEPTION";
