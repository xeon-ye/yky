...
@TableName("BUDGET_ADVANCE_BORROW")
@ApiModel(value="BudgetAdvanceBorrow对象", description="预算-事前借款")
public class BudgetAdvanceBorrow extends Model<BudgetAdvanceBorrow> {
    ...
    public static final String USE_APPLY_FOR_AMOUNT = "USE_APPLY_FOR_AMOUNT";
