...
@TableName("BASE_DOCUMENT_TYPE_UNIT")
@ApiModel(value="BaseDocumentTypeUnit对象", description="单据类型-组织单位关系")
public class BaseDocumentTypeUnit extends Model<BaseDocumentTypeUnit> {
