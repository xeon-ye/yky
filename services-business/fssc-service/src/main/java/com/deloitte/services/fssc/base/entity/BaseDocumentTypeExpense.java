...
@TableName("BASE_DOCUMENT_TYPE_EXPENSE")
@ApiModel(value="BaseDocumentTypeExpense对象", description="单据类型-支出大类关系")
public class BaseDocumentTypeExpense extends Model<BaseDocumentTypeExpense> {
