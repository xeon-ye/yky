...
@TableName("REP_RECIEVE_PAYMENT")
@ApiModel(value="RecievePayment对象", description="收款单头表")
public class RecievePayment extends Model<RecievePayment> {
    ...
    @TableField("SOURCE_DURING")
    private String sourceDuring;

    @ApiModelProperty(value = "收款方式")
    @TableField("RECIEVE_PAYMENT_TYPE")
    ...
    @TableField(value = "PROJECT_UNIT_ID",strategy = FieldStrategy.IGNORED)
    private Long projectUnitId;

    @ApiModelProperty(value = "项目承担单位code")
    @TableField(value = "PROJECT_UNIT_CODE",strategy = FieldStrategy.IGNORED)
    private String projectUnitCode;

    @ApiModelProperty(value = "项目承担单位名称")
    @TableField(value = "PROJECT_UNIT_NAME",strategy = FieldStrategy.IGNORED)
    ...
    @TableField(value = "INCOME_CLAIM_STATUS",strategy = FieldStrategy.IGNORED)
    private String incomeClaimStatus;

    @ApiModelProperty(value = "已认领金额")
    @TableField("INCOME_CLAIM_AMOUNT")
    ...
    public static final String INCOME_CLAIM_STATUS="INCOME_CLAIM_STATUS";
    public static final String ID = "ID";

    public static final String SK_TOTAL="SK_TOTAL";
    ...
    public static final String SOURCE_DURING = "SOURCE_DURING";

    public static final String RECIEVE_PAYMENT_TYPE = "RECIEVE_PAYMENT_TYPE";
