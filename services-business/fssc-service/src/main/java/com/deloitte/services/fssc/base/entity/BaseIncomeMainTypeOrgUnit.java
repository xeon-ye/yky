...
@TableName("BASE_INCOME_MAIN_TYPE_ORG_UNIT")
@ApiModel(value="BaseIncomeMainTypeOrgUnit对象", description="收入大类-组织单位关系")
public class BaseIncomeMainTypeOrgUnit extends Model<BaseIncomeMainTypeOrgUnit> {
