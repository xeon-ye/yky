...
@TableName("PY_PAMENT_BUSINESS_LINE")
@ApiModel(value="PyPamentBusinessLine对象", description="付款单公务卡")
public class PyPamentBusinessLine extends Model<PyPamentBusinessLine> {
    ...
    @ApiModelProperty(value = "行类型 PUBLIC/PRIVATE/BUSINESS_CARD")
    @TableField("LINE_TYPE")
    private String  lineType;

    @ApiModelProperty(value = "收款人Id")
    @TableField("RECIEVE_ID")
    ...
    @TableField("CONNECT_DOCUMENT_ID_LINE")
    private Long connectDocumentIdLine;

    @TableField("CONNECT_DOCUMENT_TYPE_NAME")
    ...
    public static final String BUSINESS_CARD_NUM = "BUSINESS_CARD_NUM";
