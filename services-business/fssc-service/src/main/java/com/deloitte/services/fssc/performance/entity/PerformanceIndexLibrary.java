...
@TableName("PERFORMANCE_INDEX_LIBRARY")
@ApiModel(value="PerformanceIndexLibrary对象", description="绩效指标库")
public class PerformanceIndexLibrary extends Model<PerformanceIndexLibrary> {
