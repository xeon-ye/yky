...
@TableName("PY_PAMENT_PUBLIC_LINE")
@ApiModel(value="PyPamentPublicLine对象", description="付款单对公付款")
public class PyPamentPublicLine extends Model<PyPamentPublicLine> {
