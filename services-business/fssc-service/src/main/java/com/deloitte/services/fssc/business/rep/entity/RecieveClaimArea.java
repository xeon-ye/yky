...
@TableName("REP_RECIEVE_CLAIM_AREA")
@ApiModel(value="RecieveClaimArea对象", description="收款单款项认领范围")
public class RecieveClaimArea extends Model<RecieveClaimArea> {
    ...
    public static final String CLAIM_DEPT_CODE = "CLAIM_DEPT_CODE";

    public static final String CLAIM_DEPT_NAME = "CLAIM_DEPT_NAME";

    public static final String CLAIM_DEPT_ID = "CLAIM_DEPT_ID";

    public static final String CLAIM_EMP_ID = "CLAIM_EMP_ID";

    public static final String CLAIM_EMP_NAME = "CLAIM_EMP_NAME";

    public static final String CLAIM_EMP_NO = "CLAIM_EMP_NO";
