...
@TableName("PPC_NO_PROJECT_CONFIRMATION")
@ApiModel(value="NoProjectConfirmation对象", description="非项目款项确认单头表")
public class NoProjectConfirmation extends Model<NoProjectConfirmation> {
