...
@TableName("BUDGET_ADVANCE_APPLY_FOR")
@ApiModel(value="BudgetAdvanceApplyFor对象", description="预算-事前申请")
public class BudgetAdvanceApplyFor extends Model<BudgetAdvanceApplyFor> {
    ...
    public static final String APPLY_FOR_AMOUNT = "APPLY_FOR_AMOUNT";
