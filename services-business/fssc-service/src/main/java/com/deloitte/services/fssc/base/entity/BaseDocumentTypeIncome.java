...
@TableName("BASE_DOCUMENT_TYPE_INCOME")
@ApiModel(value="BaseDocumentTypeIncome对象", description="单据类型-收入大类关系")
public class BaseDocumentTypeIncome extends Model<BaseDocumentTypeIncome> {
