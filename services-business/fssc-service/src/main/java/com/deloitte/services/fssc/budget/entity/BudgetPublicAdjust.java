...
@TableName("BUDGET_PUBLIC_ADJUST")
@ApiModel(value="BudgetPublicAdjust对象", description="预算调整-公费调整头表")
public class BudgetPublicAdjust extends Model<BudgetPublicAdjust> {
    ...
    @TableField("ANNUAL_BUDGET_AMOUNT")
    ...
    public static final String ANNUAL_BUDGET_AMOUNT = "ANNUAL_BUDGET_AMOUNT";
