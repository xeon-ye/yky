...
@TableName("BUDGET_DETAILING_ADJUST_LINE")
@ApiModel(value="BudgetDetailingAdjustLine对象", description="预算调整-预算细化调整行表")
public class BudgetDetailingAdjustLine extends Model<BudgetDetailingAdjustLine> {
    ...
    public static final String ALLOCATION_AMOUNT = "ALLOCATION_AMOUNT";
