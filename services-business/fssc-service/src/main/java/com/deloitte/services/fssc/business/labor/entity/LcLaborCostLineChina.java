...
@TableName("LC_LABOR_COST_LINE_CHINA")
@ApiModel(value="LcLaborCostLineChina对象", description="劳务费报账单行表--中国籍")
public class LcLaborCostLineChina extends Model<LcLaborCostLineChina> {
