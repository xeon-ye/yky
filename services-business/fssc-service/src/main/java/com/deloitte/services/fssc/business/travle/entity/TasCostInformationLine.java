...
@TableName("TAS_COST_INFORMATION_LINE")
@ApiModel(value="TasCostInformationLine对象", description="")
public class TasCostInformationLine extends Model<TasCostInformationLine> {
    ...
    public static final String CONNECT_COST_TYPE = "CONNECT_COST_TYPE";
