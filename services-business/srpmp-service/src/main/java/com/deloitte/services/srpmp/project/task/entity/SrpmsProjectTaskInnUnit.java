...
@TableName("SRPMS_PROJECT_TASK_INN_UNIT")
@ApiModel(value="SrpmsProjectTaskInnUnit对象", description="")
public class SrpmsProjectTaskInnUnit extends Model<SrpmsProjectTaskInnUnit> {
