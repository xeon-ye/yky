...
@TableName("SRPMS_PROJECT_BUDGET_APPLY")
@ApiModel(value="SrpmsProjectBudgetApply对象", description="项目申请预算书")
public class SrpmsProjectBudgetApply extends Model<SrpmsProjectBudgetApply> {
