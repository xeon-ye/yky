...
@TableName("SRPMS_PROJECT_SYNC_MSG")
@ApiModel(value="SrpmsProjectSyncMsg对象", description="MQ消息同步日志表")
public class SrpmsProjectSyncMsg extends Model<SrpmsProjectSyncMsg> {
