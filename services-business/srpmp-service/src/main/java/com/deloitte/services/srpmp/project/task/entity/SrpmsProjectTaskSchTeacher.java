...
@TableName("SRPMS_PROJECT_TASK_SCH_TEACHER")
@ApiModel(value="SrpmsProjectTaskSchTeacher对象", description="任务书-校基科费-教师项目")
public class SrpmsProjectTaskSchTeacher extends Model<SrpmsProjectTaskSchTeacher> {
