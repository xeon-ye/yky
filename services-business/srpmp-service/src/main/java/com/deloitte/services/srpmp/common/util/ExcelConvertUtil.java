...
public class ExcelConvertUtil {
    ...
    public static void main(String[] args) throws Exception {
       readExcelToHtml("C:\\Software\\apache-tomcat-8.5.38\\webapps\\ROOT\\123.xlsx","C:\\Software\\apache-tomcat-8.5.38\\webapps\\ROOT\\123.html",true);
       /* try {

            String  html  = "C:\\Software\\apache-tomcat-8.5.38\\webapps\\ROOT\\xx.html";
            Document document = new Document(PageSize.LETTER);
            PdfWriter pdfWriter = PdfWriter.getInstance(document,
                    new FileOutputStream("C:\\Software\\apache-tomcat-8.5.38\\webapps\\ROOT\\testpdf.pdf"));
            document.open();
            ...
            worker.parseXHtml(pdfWriter, document, new FileInputStream(html),null,null,new AsianFontProvider());
            document.close();
    ...
    public static String readExcelToHtml(String filePath ,String htmlPositon, boolean isWithStyle){
        ...
        try {
            ...
            if (wb instanceof XSSFWorkbook) {   //03版excel处理方法
                ...
                htmlExcel = ExcelConvertUtil.getExcelInfo(xWb,isWithStyle);
            }else if(wb instanceof HSSFWorkbook){  //07及10版以后的excel处理方法
                HSSFWorkbook hWb = (HSSFWorkbook) wb;
                htmlExcel = ExcelConvertUtil.getExcelInfo(hWb,isWithStyle);
            }
