    ...
    **/
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String tempbody="<xml version=\"1.0\" encoding=\"GBK\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:Fireway=\"http://www.agree.com.cn/Fireway\"><soapenv:Header><Fireway:HeadType><Fireway:versionNo>1</Fireway:versionNo><Fireway:toEncrypt>0</Fireway:toEncrypt><Fireway:commCode>900001</Fireway:commCode><Fireway:commType>0</Fireway:commType><Fireway:receiverId>FWFO</Fireway:receiverId><Fireway:senderId>FWBO</Fireway:senderId><Fireway:senderSN>48322637</Fireway:senderSN><Fireway:senderDate>20141012</Fireway:senderDate><Fireway:senderTime>070054</Fireway:senderTime><Fireway:tradeCode>BP9200</Fireway:tradeCode><Fireway:gwErrorCode>01</Fireway:gwErrorCode><Fireway:gwErrorMessage></Fireway:gwErrorMessage></Fireway:HeadType></soapenv:Header><soapenv:Body><Fireway:BPS><Fireway:field name=\"ERRORCODE\">0446</Fireway:field><Fireway:field name=\"SRCCASEID\">A00010023201410128246298</Fireway:field><Fireway:field name=\"CONTRACTSTATUS\">6</Fireway:field></Fireway:BPS></soapenv:Body></soapenv:Envelope>";
            if(tempbody.indexOf("CONTRACTSTATUS\">") != -1) {
                tempbody=tempbody.substring(tempbody.indexOf("CONTRACTSTATUS\">"), tempbody.length());
                String contractStatus = tempbody.substring(tempbody.indexOf("CONTRACTSTATUS\">") + "CONTRACTSTATUS\">".length(), tempbody.indexOf("</Fireway:field>"));
