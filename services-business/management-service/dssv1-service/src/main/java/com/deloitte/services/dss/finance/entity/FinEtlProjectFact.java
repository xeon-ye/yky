...
@TableName("DSS_FIN_ETL_PROJECT_FACT")
@ApiModel(value="DssFinEtlProjectFact对象", description="三年项目库事实表")
public class FinEtlProjectFact extends Model<FinEtlProjectFact> {
