...
@TableName("DSS_FIN_ETL_PRETREATMENT")
@ApiModel(value="FinEtlPretreatment对象", description="财务指标预处理表")
public class FinEtlPretreatment extends Model<FinEtlPretreatment> {
