...
public class FundViewController {
    ...
    public Result queryFundTotal(@PathVariable String dependDeptId){
    ...
    @ApiImplicitParam(paramType = "path",name = "dependDeptId",required = true)
    public Result queryFundDetail(@PathVariable String dependDeptId){
    ...
    @ApiImplicitParam(paramType = "path",name = "dependDeptId",required = true)
    public Result queryResult(@PathVariable String dependDeptId){
    ...
    @ApiImplicitParam(paramType = "path",name = "dependDeptId",required = true)
    public  Result queryProjectDetail(@PathVariable String dependDeptId){
        return Result.success(iFundViewService.queryProportion(dependDeptId));
    }
}
