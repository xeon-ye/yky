...
public class RegionalServiceImpl extends ServiceImpl implements IRegionalService {
    ...
    public Map queryCurYearData(Map map){
        ...
        RegionalTotalVo regionalTotalVo = regionalMapper.queryTotalNum(map);
        Double recevieOutlay = regionalMapper.queryReceviceOutlay(map);
        Map<String,Object>  resultMap = new HashMap();
        resultMap.put("totalTaskNum",regionalTotalVo.getTotalTaskNum());
        resultMap.put("totalNum",regionalTotalVo.getTotalNum());
        ...
        //查询论文、专利 相关数据
        List<ResultVo> resultVos = fundViewMapper.queryResult(category);
