...
@TableName("PROJECT_PO")
@ApiModel(value="Po对象", description="采购内容")
public class Po extends Model<Po> {
    ...
    public static final String MTL_NAME = "MTL_NAME";

    public static final String MTL_QUANTITY = "MTL_QUANTITY";

    public static final String MTL_UNIT_PRICE = "MTL_UNIT_PRICE";
