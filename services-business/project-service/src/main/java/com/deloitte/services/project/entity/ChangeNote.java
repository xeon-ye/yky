...
@TableName("PROJECT_CHANGE_NOTE")
@ApiModel(value="ChangeNote对象", description="项目执行变更记录")
public class ChangeNote extends Model<ChangeNote> {
    ...
    public static final String MAINTID = "MAINTID";
