...
@TableName("PROJECT_PERFORMANCE_BAK")
@ApiModel(value="PerformanceBak对象", description="项目绩效备份")
public class PerformanceBak extends Model<PerformanceBak> {
    ...
    public static final String LIB_CODE = "LIB_CODE";
