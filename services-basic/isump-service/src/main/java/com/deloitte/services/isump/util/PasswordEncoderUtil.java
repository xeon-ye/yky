...
public class PasswordEncoderUtil {
     ...
     */
    public static boolean passwordVerify(String password, String md5str) {
    ...
    public static void main(String[] args) {
        ...
        // 获取加盐后的MD5值
        String ciphertext = PasswordEncoderUtil.getSaltMd5AndSha(plaintext);
        System.out.println("加盐后MD5：" + ciphertext);
        System.out.println("是否是同一字符串:" + PasswordEncoderUtil.passwordVerify(plaintext, ciphertext));
    }
}
