 ...
 * @Description :   SrpmsProjectApplyInnCoo查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectApplyInnCoo查询表单")
@Data
public class SrpmsProjectApplyInnCooQueryForm extends BaseQueryForm<SrpmsProjectApplyInnCooQueryParam>  {
