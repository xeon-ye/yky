 ...
 * @Description :   EmployeeMesLearn查询from对象
 * @Modified :
 */
@ApiModel("EmployeeMesLearn查询表单")
@Data
public class EmployeeMesLearnQueryForm extends BaseQueryForm<EmployeeMesLearnQueryParam>  {
