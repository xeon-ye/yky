 ...
 * @Description : PerSelfTarget返回的VO对象
 * @Modified :
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class PerSelfTargetVo extends BaseVo {
    ...
    @ApiModelProperty(value = "一级指标-名称")
    private String firstPerName;

    @ApiModelProperty(value = "二级指标")
    private String secondPer;

    @ApiModelProperty(value = "二级指标-名称")
    private String secondPerName;

    @ApiModelProperty(value = "三级指标")
    private String thiredPer;

    @ApiModelProperty(value = "三级指标-名称")
    private String thiredPerName;
