 ...
 * @Description :   ReportEduDoStatis查询from对象
 * @Modified :
 */
@ApiModel("ReportEduDoStatis查询表单")
@Data
public class ReportEduDoStatisQueryForm extends BaseQueryForm<ReportEduDoStatisQueryParam>  {
