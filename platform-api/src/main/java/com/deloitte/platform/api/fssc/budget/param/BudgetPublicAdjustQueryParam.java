 ...
 * @Description :  BudgetPublicAdjust查询参数
 * @Modified :
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
public class BudgetPublicAdjustQueryParam extends BaseParam {
    ...
    private Double annualBudgetAmount;
    private Double periodBudgetAmount;
    private Double periodUsableAmount;
