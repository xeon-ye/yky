 ...
 * @Description :   SrpmsProjectBudgetApply查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectBudgetApply查询表单")
@Data
public class SrpmsProjectBudgetApplyQueryForm extends BaseQueryForm<SrpmsProjectBudgetApplyQueryParam>  {
