 ...
 * @Description :   OaMeetingHeader查询from对象
 * @Modified :
 */
@ApiModel("OaMeetingHeader查询表单")
@Data
public class OaMeetingHeaderQueryForm extends BaseQueryForm<OaMeetingHeaderQueryParam>  {


    @ApiModelProperty(value = "主键")
    private String id;

    @ApiModelProperty(value = "会议预定编码")
