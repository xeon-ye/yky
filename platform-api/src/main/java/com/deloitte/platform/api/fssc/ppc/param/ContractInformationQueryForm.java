 ...
 * @Description :   ContractInformation查询from对象
 * @Modified :
 */
@ApiModel("ContractInformation查询表单")
@Data
public class ContractInformationQueryForm extends BaseQueryForm<ContractInformationQueryParam>  {
