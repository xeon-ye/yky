 ...
 * @Description : PyPamentBusinessLine新增修改form对象
 * @Modified :
 */
@ApiModel("新增PyPamentBusinessLine表单")
@Data
public class PyPamentBusinessLineForm extends BaseForm {
    ...
    @ApiModelProperty(value = "行类型提交类型 PUBLIC/PRIVATE/BUSINESS_CARD",required = true)
