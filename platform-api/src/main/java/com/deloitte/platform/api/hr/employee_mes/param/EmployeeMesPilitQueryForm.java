 ...
 * @Description :   EmployeeMesPilit查询from对象
 * @Modified :
 */
@ApiModel("EmployeeMesPilit查询表单")
@Data
public class EmployeeMesPilitQueryForm extends BaseQueryForm<EmployeeMesPilitQueryParam>  {
