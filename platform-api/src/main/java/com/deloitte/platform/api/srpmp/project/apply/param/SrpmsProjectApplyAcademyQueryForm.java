 ...
 * @Description :   SrpmsProjectApplyAcademy查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectApplyAcademy查询表单")
@Data
public class SrpmsProjectApplyAcademyQueryForm extends BaseQueryForm<SrpmsProjectApplyAcademyQueryParam>  {
