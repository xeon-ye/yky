 ...
 * @Description :   HrGraduateInformation查询from对象
 * @Modified :
 */
@ApiModel("HrGraduateInformation查询表单")
@Data
public class HrGraduateInformationQueryForm extends BaseQueryForm<HrGraduateInformationQueryParam>  {
