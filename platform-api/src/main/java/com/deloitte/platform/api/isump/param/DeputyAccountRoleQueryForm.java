 ...
 * @Description :   DeputyAccountRole查询from对象
 * @Modified :
 */
@ApiModel("DeputyAccountRole查询表单")
@Data
public class DeputyAccountRoleQueryForm extends BaseQueryForm<DeputyAccountRoleQueryParam>  {
