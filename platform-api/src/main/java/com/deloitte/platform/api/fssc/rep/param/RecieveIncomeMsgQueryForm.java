 ...
 * @Description :   RecieveIncomeMsg查询from对象
 * @Modified :
 */
@ApiModel("RecieveIncomeMsg查询表单")
@Data
public class RecieveIncomeMsgQueryForm extends BaseQueryForm<RecieveIncomeMsgQueryParam>  {
