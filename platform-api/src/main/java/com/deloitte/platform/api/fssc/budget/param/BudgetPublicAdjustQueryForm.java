 ...
 * @Description :   查询from对象
 * @Modified :
 */
@ApiModel("BudgetPublicAdjust查询表单")
@Data
public class BudgetPublicAdjustQueryForm extends BaseQueryForm<BudgetPublicAdjustQueryParam>  {
    ...
    private BigDecimal annualBudgetAmountUp;

    @ApiModelProperty(value = "年度预算金额-下限")
    private BigDecimal annualBudgetAmountDown;
