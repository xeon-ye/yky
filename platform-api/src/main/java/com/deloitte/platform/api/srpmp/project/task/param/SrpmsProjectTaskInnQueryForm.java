 ...
 * @Description :   SrpmsProjectTaskInn查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectTaskInn查询表单")
@Data
public class SrpmsProjectTaskInnQueryForm extends BaseQueryForm<SrpmsProjectTaskInnQueryParam>  {
