 ...
 * @Description :   EquipmentTransform查询from对象
 * @Modified :
 */
@ApiModel("EquipmentTransform查询表单")
@Data
public class EquipmentTransformQueryForm extends BaseQueryForm<EquipmentTransformQueryParam>  {
