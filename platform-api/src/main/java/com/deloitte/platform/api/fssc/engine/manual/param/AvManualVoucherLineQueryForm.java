 ...
 * @Description :   AvManualVoucherLine查询from对象
 * @Modified :
 */
@ApiModel("AvManualVoucherLine查询表单")
@Data
public class AvManualVoucherLineQueryForm extends BaseQueryForm<AvManualVoucherLineQueryParam>  {
