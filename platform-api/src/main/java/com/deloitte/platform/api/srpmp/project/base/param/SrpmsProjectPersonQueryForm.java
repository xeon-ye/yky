 ...
 * @Description :   SrpmsProjectPerson查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectPerson查询表单")
@Data
public class SrpmsProjectPersonQueryForm extends BaseQueryForm<SrpmsProjectPersonQueryParam>  {
