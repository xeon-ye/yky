 ...
 * @Description :   PyPamentBusinessLine查询from对象
 * @Modified :
 */
@ApiModel("PyPamentBusinessLine查询表单")
@Data
public class PyPamentBusinessLineQueryForm extends BaseQueryForm<PyPamentBusinessLineQueryParam>  {
