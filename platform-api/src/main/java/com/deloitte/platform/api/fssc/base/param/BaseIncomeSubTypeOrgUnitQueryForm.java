 ...
 * @Description :   收入小类-组织单位关系查询表单
 * @Modified :
 */
@ApiModel("收入小类-组织单位关系查询表单")
@Data
public class BaseIncomeSubTypeOrgUnitQueryForm extends BaseQueryForm<BaseIncomeMainTypeQueryOrgUnitParam>  {
