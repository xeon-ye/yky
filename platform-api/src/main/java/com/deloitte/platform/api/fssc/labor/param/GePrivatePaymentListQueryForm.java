 ...
 * @Description :   GePrivatePaymentList查询from对象
 * @Modified :
 */
@ApiModel("GePrivatePaymentList查询表单")
@Data
public class GePrivatePaymentListQueryForm extends BaseQueryForm<GePrivatePaymentListQueryParam>  {
