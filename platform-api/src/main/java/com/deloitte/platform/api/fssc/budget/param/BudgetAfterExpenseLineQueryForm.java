 ...
 * @Description :   BudgetAfterExpenseLine查询from对象
 * @Modified :
 */
@ApiModel("BudgetAfterExpenseLine查询表单")
@Data
public class BudgetAfterExpenseLineQueryForm extends BaseQueryForm<BudgetAfterExpenseLineQueryParam>  {
