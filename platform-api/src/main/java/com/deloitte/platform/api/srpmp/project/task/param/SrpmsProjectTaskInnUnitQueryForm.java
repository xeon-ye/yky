 ...
 * @Description :   SrpmsProjectTaskInnUnit查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectTaskInnUnit查询表单")
@Data
public class SrpmsProjectTaskInnUnitQueryForm extends BaseQueryForm<SrpmsProjectTaskInnUnitQueryParam>  {
