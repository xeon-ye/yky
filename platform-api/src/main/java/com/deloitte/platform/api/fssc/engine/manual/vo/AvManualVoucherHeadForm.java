 ...
 * @Description : AvManualVoucherHead新增修改form对象
 * @Modified :
 */
@ApiModel("新增AvManualVoucherHead表单")
@Data
public class AvManualVoucherHeadForm extends BaseForm {
    ...
    private List<AvManualVoucherLineForm> lineList;
