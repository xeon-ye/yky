 ...
 * @Description :   SrpmsProjectBudgetDevice查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectBudgetDevice查询表单")
@Data
public class SrpmsProjectBudgetDeviceQueryForm extends BaseQueryForm<SrpmsProjectBudgetDeviceQueryParam>  {
