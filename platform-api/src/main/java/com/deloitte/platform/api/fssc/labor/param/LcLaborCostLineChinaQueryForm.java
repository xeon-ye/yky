 ...
 * @Description :   LcLaborCostLineChina查询from对象
 * @Modified :
 */
@ApiModel("LcLaborCostLineChina查询表单")
@Data
public class LcLaborCostLineChinaQueryForm extends BaseQueryForm<LcLaborCostLineChinaQueryParam>  {
