 ...
 * @Description :   BudgetAdvanceApplyFor查询from对象
 * @Modified :
 */
@ApiModel("BudgetAdvanceApplyFor查询表单")
@Data
public class BudgetAdvanceApplyForQueryForm extends BaseQueryForm<BudgetAdvanceApplyForQueryParam>  {
