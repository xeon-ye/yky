 ...
 * @Description :   TasCostInformationLine查询from对象
 * @Modified :
 */
@ApiModel("TasCostInformationLine查询表单")
@Data
public class TasCostInformationLineQueryForm extends BaseQueryForm<TasCostInformationLineQueryParam>  {
