 ...
 * @Description : GccPostgraduateGuidance返回的VO对象
 * @Modified :
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GccPostgraduateGuidanceVo extends BaseVo {
    ...
    private String doctoralGraduatesNum;

    @ApiModelProperty(value = "博士再度人数")
    private String doctoralCandidates;

    @ApiModelProperty(value = "硕士生毕业人数")
    private String graduateStudentsNum;

    @ApiModelProperty(value = "硕士生再度人数")
    private String degreeCandidates;
