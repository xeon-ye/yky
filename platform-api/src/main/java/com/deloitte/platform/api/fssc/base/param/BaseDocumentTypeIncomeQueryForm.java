 ...
 * @Description :   单据类型-收入大类关联 查询from对象
 * @Modified :
 */
@ApiModel("单据类型-收入大类关联 查询表单")
@Data
public class BaseDocumentTypeIncomeQueryForm extends BaseQueryForm<BaseDocumentTypeIncomeQueryParam>  {
