 ...
 * @Description :   OaScheduleHistory查询from对象
 * @Modified :
 */
@ApiModel("OaScheduleHistory查询表单")
@Data
public class OaScheduleHistoryQueryForm extends BaseQueryForm<OaScheduleHistoryQueryParam>  {
