 ...
 * @Description :   ReportDeptBudgetDoStatis查询from对象
 * @Modified :
 */
@ApiModel("ReportDeptBudgetDoStatis查询表单")
@Data
public class ReportDeptBudgetDoStatisQueryForm extends BaseQueryForm<ReportDeptBudgetDoStatisQueryParam>  {
