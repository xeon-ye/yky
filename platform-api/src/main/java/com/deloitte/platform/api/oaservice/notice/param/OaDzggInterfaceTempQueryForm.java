 ...
 * @Description :   OaDzggInterfaceTemp查询from对象
 * @Modified :
 */
@ApiModel("OaDzggInterfaceTemp查询表单")
@Data
public class OaDzggInterfaceTempQueryForm extends BaseQueryForm<OaDzggInterfaceTempQueryParam>  {
