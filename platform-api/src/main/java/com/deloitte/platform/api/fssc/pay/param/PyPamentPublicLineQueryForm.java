 ...
 * @Description :   PyPamentPublicLine查询from对象
 * @Modified :
 */
@ApiModel("PyPamentPublicLine查询表单")
@Data
public class PyPamentPublicLineQueryForm extends BaseQueryForm<PyPamentPublicLineQueryParam>  {
