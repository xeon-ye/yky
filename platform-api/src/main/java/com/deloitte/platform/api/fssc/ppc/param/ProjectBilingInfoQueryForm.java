 ...
 * @Description :   ProjectBilingInfo查询from对象
 * @Modified :
 */
@ApiModel("ProjectBilingInfo查询表单")
@Data
public class ProjectBilingInfoQueryForm extends BaseQueryForm<ProjectBilingInfoQueryParam>  {
