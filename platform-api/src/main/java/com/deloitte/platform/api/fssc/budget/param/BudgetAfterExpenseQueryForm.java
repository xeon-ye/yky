 ...
 * @Description :   BudgetAfterExpense查询from对象
 * @Modified :
 */
@ApiModel("BudgetAfterExpense查询表单")
@Data
public class BudgetAfterExpenseQueryForm extends BaseQueryForm<BudgetAfterExpenseQueryParam>  {
