...
import com.deloitte.platform.api.fssc.engine.manual.param.AvManualVoucherLineQueryParam;
 ...
 * @Description : AvManualVoucherHead返回的VO对象
 * @Modified :
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AvManualVoucherHeadVo extends BaseVo {
    ...
    @ApiModelProperty(value = "过账状态(Y/N)")
    ...
    private String fromRecurringHeaderId;

    @ApiModelProperty(value = "过账时间")
    private LocalDateTime postedDate;

    @ApiModelProperty(value = "冲销凭证头ID")
    private String accrualRevJeHeaderId;
    ...
    private List<AvManualVoucherLineVo> lineList;
    @ApiModelProperty(value = "页面状态")
    private  String pageType;//新建，复制，查看，编辑
    ...
    private String accountResourceTypeId;
    ...
    @ApiModelProperty(value = "上传附件的Id集合")
