 ...
 * @Description :   MprAcadPostTable查询from对象
 * @Modified :
 */
@ApiModel("MprAcadPostTable查询表单")
@Data
public class MprAcadPostTableQueryForm extends BaseQueryForm<MprAcadPostTableQueryParam>  {
