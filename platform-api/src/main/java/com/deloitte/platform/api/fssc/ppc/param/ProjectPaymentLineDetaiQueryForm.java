 ...
 * @Description :   ProjectPaymentLineDetai查询from对象
 * @Modified :
 */
@ApiModel("ProjectPaymentLineDetai查询表单")
@Data
public class ProjectPaymentLineDetaiQueryForm extends BaseQueryForm<ProjectPaymentLineDetaiQueryParam>  {
