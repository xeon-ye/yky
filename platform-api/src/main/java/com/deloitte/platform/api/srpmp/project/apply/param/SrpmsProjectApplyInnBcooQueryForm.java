 ...
 * @Description :   SrpmsProjectApplyInnBcoo查询from对象
 * @Modified :
 */
@ApiModel("SrpmsProjectApplyInnBcoo查询表单")
@Data
public class SrpmsProjectApplyInnBcooQueryForm extends BaseQueryForm<SrpmsProjectApplyInnBcooQueryParam>  {
