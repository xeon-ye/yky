 ...
 * @Description :   ProjectConfirmation查询from对象
 * @Modified :
 */
@ApiModel("ProjectConfirmation查询表单")
@Data
public class ProjectConfirmationQueryForm extends BaseQueryForm<ProjectConfirmationQueryParam>  {
