 ...
 * @Description :   CrbAssocAdvancePayment查询from对象
 * @Modified :
 */
@ApiModel("CrbAssocAdvancePayment查询表单")
@Data
public class CrbAssocAdvancePaymentQueryForm extends BaseQueryForm<CrbAssocAdvancePaymentQueryParam>  {
