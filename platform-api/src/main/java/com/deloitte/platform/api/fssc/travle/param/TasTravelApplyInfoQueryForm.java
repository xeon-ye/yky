 ...
 * @Description :   TasTravleApplyInfo查询from对象
 * @Modified :
 */
@ApiModel("TasTravleApplyInfo查询表单")
@Data
public class TasTravelApplyInfoQueryForm extends BaseQueryForm<TasTravelApplyInfoQueryParam>  {
